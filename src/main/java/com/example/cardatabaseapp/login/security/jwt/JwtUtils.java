package com.example.cardatabaseapp.login.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${carDatabaseApp.app.jwtSecret}")
    private String jwtSecret;
    @Value("${carDatabaseApp.app.jwtExpirationMs}")
    private int jwtExpirationMs;
    @Value("${carDatabaseApp.app.jwtCookieName}")
